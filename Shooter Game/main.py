...
player = Entity(250, 250, 3, 3, 20, 5, "player")
enemy = Entity(200, 200, 4, 2, 20, 0, "enemy")
...
while running:
    ...
    if player.alive:
        ...
        elif grenade and (not player.in_air) and grenade_thrown == False and player.grenade > 0:
